...
def test_stop_words_remover:
    ...
    assert function7.stop_words_remover(twitter_df.copy()).loc[4, 'Without Stop Words'] == ['#eskomfreestate', '#mediastatement', ':', 'eskom', 'suspends', 'planned', 'electricity', 'supply', 'interruptions', 'mangaung', 'metropolitan…', 'https://t.co/mtbo6gjcte'], incorrect
